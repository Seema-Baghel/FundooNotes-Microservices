...
public interface NoteRepository extends JpaRepository<NoteModel, Long>{
	...
	@Modifying
	@Query(value = "update note_model set description = :description , title = :title , updated_date = :updatedDate where note_id = :noteId", nativeQuery = true)
	void updateData(String description, String title, LocalDateTime updatedDate, long noteId);
